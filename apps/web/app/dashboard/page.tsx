...
export default function DashboardPage() {
  ...
  useQueryErrorToast({ error: dashboardQuery.error, fallbackMessage: "???????", isError: dashboardQuery.isError });
