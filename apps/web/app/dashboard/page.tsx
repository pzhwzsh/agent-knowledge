...
export default function DashboardPage() {
  ...
  const submitMutation = useMutation({
    ...
    onMutate: () => setMessage("正在提交给 Agent..."),
    ...
    onError: (error) => setMessage(error instanceof Error ? error.message : "提交失败"),
  });
