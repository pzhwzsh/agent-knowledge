...
export default function RecommendationsPage() {
  ...
  const actionMutation = useMutation({
    ...
    onSuccess: async (action) => {
      setMessage(action === "save" ? "已保存到知识库。" : "推荐状态已更新。后续相似推荐会参考这次反馈。");
