...
- 前端 API client 已补 timeout、AbortController 和统一 401；React Query 已接入并迁移 dashboard/recommendations，全局 toast 第二批、全局错误页和页面级 skeleton 第一批已完成；仍缺 documents 页面提示迁移和统一 loading。
